...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    def test_find_sentiments(self):
       self.assertEqual(self.df.find_sentiments(), ([0.0, 0.13333333333333333, 0.3166666666666667, 0.16666666666666666, 0.3], [0.0, 0.45555555555555555, 0.48333333333333334, 0.16666666666666666, 0.7666666666666666]))
